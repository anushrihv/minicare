...
public class SeekerService {
    ...
    public SeekerModel editSeekerAccount(HttpServletRequest request) throws SQLException, NamingException {
        SeekerUtil seekerUtil = SeekerUtil.getInstance();
        SeekerDao seekerDao = SeekerDao.getInstance();
        MemberDao memberDao = MemberDao.getInstance();

        SeekerModel seekerModel = seekerUtil.populateSeekerModelFromRequest(request);
