...
public class SitterService {
    ...
    public void closeSitterAccount(int memberId) throws SQLException,NamingException{
    ...
    public SitterModel editSitterAccount(HttpServletRequest request) throws SQLException, NamingException {
